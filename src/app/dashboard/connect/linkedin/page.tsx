  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        <h1 className="text-2xl font-bold tracking-tight text-text">LinkedIn verknüpfen</h1>
        <p className="text-sm text-muted">
          Gold-Tier · OAuth. Trust-Signal: verifizierter Klarname (KYC-grade).
        </p>
      </div>
      <OAuthConnectButton platform="linkedin" />
    </div>
  );
}
